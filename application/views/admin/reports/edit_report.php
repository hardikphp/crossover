                        ...
                        <div class="well">
                            <div id="myTabContent" class="tab-content">
                                <div class="tab-pane active in" id="home">  
                                    ...
                                    <?php echo set_select('patient_id',$data['patient_id']) ?>
                                    <?php echo form_dropdown('patient_id', $patients); ?> 
                                    
                                    <label>Doctor id</label>
                                    <input type="text" value="<?php echo set_value('doctor_id',$report->doctor_id) ?>" class="input" name="doctor_id">
                                    <label class="help-inline error"><?php echo form_error('doctor_id'); ?></label>
                                    
                                    <label>Test title<span class="error">*</span></label>
                                    <input type="text" value="<?php echo set_value('title',$report->title) ?>" class="input" name="title">
                                    <label class="help-inline error"><?php echo form_error('title'); ?></label>

                                    <label>Test description<span class="error">*</span></label>
                                    <input type="text" value="<?php echo set_value('desc',$report->desc) ?>" class="input" name="desc">
                                    <label class="help-inline error"><?php echo form_error('desc'); ?></label>
                                    
                                    <label>Diagnosis<span class="error">*</span></label>
                                    <input type="text" value="<?php echo set_value('diagnosis',$report->diagnosis) ?>" class="input" name="diagnosis">
                                    <label class="help-inline error"><?php echo form_error('diagnosis'); ?></label>
                                    
                                    <label>Examination title <span class="error">*</span></label>
                                    <input type="text" value="<?php echo set_value('extitle',$report->extitle) ?>" class="input" name="extitle">
                                    <label class="help-inline error"><?php echo form_error('extitle'); ?></label>
                                    
                                    
                                    <label>Examination detail <span class="error">*</span></label>
                                    <input type="text" value="<?php echo set_value('exdetail',$report->exdetail) ?>" class="input" name="exdetail">
                                    <label class="help-inline error"><?php echo form_error('exdetail'); ?></label>


                                    <label>Status:</label>
                                    <?php echo set_select('is_active',$report->is_active) ?>
