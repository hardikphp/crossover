                        ...
                        <div class="well">
                            <div id="myTabContent" class="tab-content">
                                <div class="tab-pane active in" id="home">  
                                    ...
                                    <input type="text" value="<?php echo set_value('first_name') ?>" class="input" name="first_name">
                                    <label class="help-inline error"><?php echo form_error('first_name'); ?></label>

                                    <label>Last Name <span class="error">*</span></label>
                                    <input type="text" value="<?php echo set_value('last_name') ?>" class="input" name="last_name">
                                    <label class="help-inline error"><?php echo form_error('last_name'); ?></label>

                                    <label>Email <span class="error">*</span></label>
                                    <input type="text" value="<?php echo set_value('email') ?>" class="input" name="email">
                                    ...
                                    <label>Conform Password <span class="error">*</span></label>
                                    ...
                                    <input type="text" value="<?php echo set_value('contact_no') ?>" class="input" name="contact_no">
                                    <label class="help-inline error"><?php echo form_error('contact_no'); ?></label>

                                    <label>Address</label>
                                    <input type="text" value="<?php echo set_value('address') ?>" class="input" name="address">
                                    <label>Status:</label>
